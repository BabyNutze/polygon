				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>Sixt</span></a>
					</div>
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a href="index.php?job=addnewcar"><i class="fa fa-cab"></i> เพิ่มรถใหม่ </a>
								</li>
									<li><a><i class="fa fa-cab"></i> Forms <span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
